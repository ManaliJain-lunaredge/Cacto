...
const Leadther = () => {
  return (
    <div className="md:px-[4rem]  2xl:px-[10rem] pt-0 p-[2rem] pb-0">
      <h3 className=" 2xl:text-4xl md:text-2xl text-xl text-center font-bold text-green-700 mb-[4rem] mt-[1rem]">
        ANIMALS LEATHER REPLACEMENT BY CACTUS VEGAN
      </h3>
      <ul className="leading-loose text-xl text-justify">
        <li className="flex md:text-lg text-base mb-2 lg:text-base">
          <img src={arrow} className="w-4 h-4 mt-1 me-2" />
