    ...
    <div>
      <section class="bg-blue-50 dark:bg-slate-800 " id="contact">
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          ...
          <div class="md:flex block items-stretch justify-center">
            <div class="grid md:grid-cols-2">
              <div class="h-full 2xl:pr-6 pl-[2rem]">
                <p class="2xl:mt-[5rem] mt-[2rem] mb-12 2xl:text-xl lg:text-2xl text-gray-600 dark:text-slate-400 ">
                ...
                <ul class="mb-6 md:mb-0">
                  <li class="flex">
                    ...
                    <div class="ml-4 mb-4">
                      ...
                      <p class="text-gray-600  2xl:text-md lg:text-xl dark:text-slate-400">
              ...
              <div className="w-[80%] flex justify-center items-center mx-auto " id="form">
